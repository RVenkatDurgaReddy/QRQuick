...
export default function HomePage() {
  ...
  const handleUploadSuccess = (details: UploadResult) => {
    console.log('[HomePage] handleUploadSuccess received details:', details);
    setUploadResult(details);
  };
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4 sm:p-6 md:p-8 transition-colors duration-300">
      ...
      <main className="w-full max-w-lg space-y-8">
        ...
        {!isUploading && uploadResult && (
          <div className="mt-8 w-full space-y-6 animate-in fade-in-50 duration-500">
            <DownloadDisplay
         ...
         {isUploading && !uploadResult && (
          <div className="mt-8 w-full text-center text-muted-foreground">
             {/* Placeholder while uploading. FileUploadForm handles its own spinner. */}
          </div>
        )}
      </main>
